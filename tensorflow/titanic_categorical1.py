# https://medium.com/@ilblackdragon/tensorflow-tutorial-part-3-c5fc0662bc08#.nr7t1tcwd
import random
import pandas
import numpy as np
...
print("Accuracy: {0}".format(metrics.accuracy_score(
    classifier.predict(X_test), y_test)))
print("ROC: {0}".format(metrics.roc_auc_score(
    classifier.predict(X_test), y_test)))
